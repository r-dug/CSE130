...
Program discription: 
This program should compile into a tictactoe game executable for the commandline. 

The game should utilize classes.

A player will play against the computer.

The computer needn't be intelligent (and isn't). It randomly selects an empty cell.

Wins are determined by three cells 'in a row' being of the same non-empty value ('X' or 'O'). 
Those three cells can be on the same board are can be on different boards.
They can be 'in a row' aligned in the x, y, or z axis, or on a diagonal.

Author: Richard Douglas
Start date: 03/31/2024
...
// player class (player or computer)
class Player {
    private:
        string name;
        string role;
...
class TicTacToe {
    private:
        ...
        bool checkWin() {
            ...
            if(boards[0][0][2] == boards[1][1][1] && boards[1][1][1] == boards[2][2][0] && boards[0][0][2] != ' '){
                return true;
            }
            if(boards[0][0][2] == boards[1][2][2] && boards[1][2][2] == boards[2][2][2] && boards[0][0][2] != ' '){
                return true;
            }
            ...
            if(boards[0][2][0] == boards[1][1][0] && boards[1][1][0] == boards[2][0][0] && boards[0][2][0] != ' '){
                return true;
            }
            if(boards[0][2][0] == boards[1][2][1] && boards[1][2][1] == boards[2][2][2] && boards[0][2][0] != ' '){
                return true;
            ...
            if(boards[0][2][2] == boards[1][1][1] && boards[1][1][1] == boards[2][0][0] && boards[0][2][2] != ' '){
                return true;
            }
            if(boards[0][2][2] == boards[1][1][2] && boards[1][1][2] == boards[2][0][2] && boards[0][2][2] != ' '){
                return true;
            }
    ...
    void playGame(vector<Player>& players) {
        ...
        while(!gameover) {
            ...
            // assign X or O to selected cell
